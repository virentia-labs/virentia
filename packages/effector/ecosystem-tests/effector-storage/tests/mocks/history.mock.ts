...
export class HistoryMock implements History {
  ...
  public _callbacks({ back, forward, go, pushState, replaceState }: Partial<History>): void {
...
export function createHistoryMock(data: any, title: string, url?: string | null): History {
