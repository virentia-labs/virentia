...
it("store without sid should warn", async () => {
  ...
  const oldMsg = "There is a store without sid in this scope, its value is omitted";

  // error message after effector 23.3.0
  const newMsg = "serialize: One or more stores dont have sids, their values are omitted";
