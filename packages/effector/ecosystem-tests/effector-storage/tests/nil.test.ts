...
import { nil as nilIndex } from "effector-storage";
import { persist } from "effector-storage/core";
import { persist as local } from "effector-storage/local";
import { nil } from "effector-storage/nil";
import { persist as session } from "effector-storage/session";
