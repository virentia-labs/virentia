...
test("source: array", () => {
  ...
  type Target = Event<[string | void, string | void, string | void, string | void, string | void]>;
...
test("target", () => {
  ...
  type Target5XData = [string | void, string | void, string | void, string | void, string | void];
