...
// Virentia upstream skip reason: Проверяет upstream debug traces для skipVoid; формат сообщений не совместим с текущим ядром.
describe.skip("upstream error-stacks/debug_traces_enabled.skip-void-messages.test.ts", () => {
