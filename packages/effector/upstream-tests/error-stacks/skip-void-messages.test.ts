...
// Virentia upstream skip reason: Проверяет точный формат skipVoid error stacks, которого нет в Virentia.
describe.skip("upstream error-stacks/skip-void-messages.test.ts", () => {
