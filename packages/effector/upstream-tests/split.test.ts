...
import { createEvent, split, createEffect, createStore, createApi } from "@virentia/effector";
...
describe("split(config)", () => {
  test("array targets", () => {
    ...
    const textIsSelected = createStore(false).on(messageReceived, (_, msg) => msg.type === "text");
